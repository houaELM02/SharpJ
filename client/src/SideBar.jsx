    ...
    <div className='sidebar'>
        ...
        <div onClick={()=>props.SetProfilClicked(false)}>
          ...
          <div>
            ...
            <button className="btn-sideBar">
          <div>
            <Link to ='/Invite' className="icon_container">
            <FaUserAlt  className="icon" />
            </Link>
          <span className='title'>Inviter</span>
           </div>
           </button>



           <div style={{height:'100%',marginTop:'66px' ,justifyContent:'end',position:'relative'}} onClick={()=>
            props.SetProfilClicked(true)
           }>
           
            <img src={props.userdata.img}  style={{width:"45px",height:"40px",borderRadius:"50%"}}alt="profile" />
